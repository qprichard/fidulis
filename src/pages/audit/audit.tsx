...
export const AuditContent = () => (
    <>
        <p>Fidulis Avocat propose des audits de conformité et des audits d'acquisition. Chaque audit est adapté aux
            besoins et aux attentes des clients. Fidulis Avocat intervient sur place au sein de l'entreprise /
            association ou via une data room.</p>
        <p>
        ...
        <p>
            ...
            tout en oeuvre pour assurer les délais d'exécution exigés par la nature des opérations envisagées.
        </p>
    </>
);
